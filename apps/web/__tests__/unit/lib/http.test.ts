...
describe('http client', () => {
  ...
  it('getWithResponse returns a Response', async ({ server }) => {
    server.use(httpMsw.get('/api/test', () => HttpResponse.json({ ok: true })));
    const response = await http.getWithResponse('/api/test');
    expect(response).toBeInstanceOf(Response);
  });

  it('postWithResponse returns a Response', async ({ server }) => {
    server.use(
      httpMsw.post('/api/test', async ({ request }) => {
        const body = await request.json();
        return HttpResponse.json(body);
  ...
  it('putWithResponse returns a Response', async ({ server }) => {
    server.use(
      httpMsw.put('/api/test', async ({ request }) => {
        const body = await request.json();
        return HttpResponse.json(body);
  ...
  it('deleteWithResponse returns a Response', async ({ server }) => {
    server.use(
      httpMsw.delete('/api/test', () => HttpResponse.json({ ok: true })),
    );
